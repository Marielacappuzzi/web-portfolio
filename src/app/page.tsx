...
/**
 * Home — the whole tour, in five blocks.
 *
 ...
 *   5. Contacto        everything that is not a commission  #contacto
 *
 ...
 *
 * The "Declaración" block is gone entirely — see the note in content/home.ts.
 */
export default async function HomePage() {
  ...
  return (
    <>
      ...
      <ContactCallout content={content.contact} id="contacto" />
    </>
  );
}
